    ...
    <div>
      <div className="grid gap-x-12 gap-y-60 sm:grid-cols-2 xl:grid-cols-searchForm xl:gap-y-17.28">
        ...
        <div className="col-span-full xl:flex xl:col-auto">
          <button className="flex w-full justify-center bg-green rounded-md px-4 py-2 transition-colors hover:bg-green.700 active:bg-green.900 xl:mt-auto xl:mb-0 xl:py-4">
            <MagnifyingGlass className="fill-current text-gray.900 w-8 h-8 xl:w-6 xl:h-6 dark:text-white" />
          </button>
        </div>
      </div>
